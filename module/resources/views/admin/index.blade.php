<x-app-layout>
    ...
    <x-card class="settings-section">
        ...
        <x-slot name="description">Modules without an H1 ownership snapshot are visible, but cannot be purged by this cleaner.</x-slot>
                ...
                <article class="responsive-data-grid__row">
                    ...
                    <div class="form-actions">
                        <form method="POST" action="{{ route('admin.module-cleaner.modules.plan', $module) }}">
                            @csrf
                            <x-button type="submit" variant="secondary" :disabled="! $entry['has_snapshot']">
                                Dry Run Plan
                            </x-button>
                        </form>
                    </div>
